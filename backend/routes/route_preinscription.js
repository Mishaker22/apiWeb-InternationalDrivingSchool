...
const { updateOrder, deleteOrder, getAdminAllOrders, getMyOrders, newPrinscription, getOnePreinscriptions, cancelOrder}=require('../controllers/controller_preinscripcion');
...
router.route('/cancelOrder/:id').put(isAuthenticatedUser, cancelOrder)
